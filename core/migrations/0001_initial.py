# Generated by Django 3.2.13 on 2023-12-18 22:26
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('deal_type', models.CharField(choices=[('Looking for Financing', 'Looking for Financing'), ('Looking for Services Provider', 'Looking for Services Provider'), ('Offering for Financing', 'Offering Financing'), ('Looking for a Buyer', 'Looking for a Buyer'), ('Looking for a Seller', 'Looking for a Seller'), ('Offering Leadership Services', 'Offering Leadership Services'), ('In Search of Leadership Services', 'In Search of Leadership Services'), ('Offering Management Services', 'Offering Management Services'), ('In Search of Management Services', 'In Search of Management Services'), ('In Search of Technical Partner', 'In Search of Technical Partner'), ('Offering Technical Services', 'Offering Technical Services')], default='', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Technical_factors', models.TextField(blank=True, max_length=1000, null=True, verbose_name='This include climate,season, soil preparation,seeds, semis, care, conditions, and protection')),
                ('principal_risks', models.TextField(blank=True, max_length=368, null=True)),
                ('harvest_factors', models.TextField(blank=True, max_length=500, null=True, verbose_name='Include how to harvest, post harvest conditioning, yield')),
                ('marketing_factor', models.TextField(blank=True, max_length=500, null=True, verbose_name='include seed supplier, equipment cost, storage requirements, average price per unit (acre, kilo, tone...), average cost ')),
                ('industrialization_factors', models.TextField(blank=True, max_length=500, null=True, verbose_name='what to consider if industrializing')),
                ('other_factors', models.TextField(blank=True, max_length=200, null=True, verbose_name='Import Export opportunities, main producers, main consumers...')),
                ('created_on', models.DateTimeField(auto_now_add=True)),
                ('updated_on', models.DateTimeField(auto_now=True)),
            ],
            options={

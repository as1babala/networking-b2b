...
class CustomUser(AbstractUser):
    ...
    is_expert = models.BooleanField(_('Would like to register as an expertise'), default=False)
    #is_company = models.BooleanField('Would like to register my company', default=False)
    is_employee = models.BooleanField('Is Employee', default=False)
    commercial = models.BooleanField(_('Would like to be a commercial partner'), default=False)
